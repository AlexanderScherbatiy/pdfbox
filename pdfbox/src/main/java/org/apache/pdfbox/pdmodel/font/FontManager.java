...
public class FontManager
{
    ...
    private static InputStream loadResource( String resourceName ) throws IOException
    {
        ...
        try
        {
            loader = FontManager.class.getClassLoader();
        }
     ...
     */
    private static Properties loadProperties( String resourceName, Properties defaults ) throws IOException
    {
        InputStream is = null;
        try
        {
