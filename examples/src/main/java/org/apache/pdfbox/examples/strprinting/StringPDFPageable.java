...
// Copied from the final class PDFPageable
/**
 * Prints a PDF document using its original paper size.
 *
 * @author John Hewson
 */
public final class StringPDFPageable extends Book
{
    ...
    /**
     * Creates a new StringPDFPageable.
     *
     * @param document the document to print
     */
    public StringPDFPageable(PDDocument document)
    {
        this(document, Orientation.AUTO, false, 0);
    }

    /**
     * Creates a new StringPDFPageable with the given page orientation.
     *
     * @param document the document to print
     * @param orientation page orientation policy
     */
    public StringPDFPageable(PDDocument document, Orientation orientation)
    {
        this(document, orientation, false, 0);
    }

    /**
     * Creates a new StringPDFPageable with the given page orientation and with optional page borders
     ...
     */
    public StringPDFPageable(PDDocument document, Orientation orientation, boolean showPageBorder)
    {
    ...
    public Printable getPrintable(int i)
    {
        ...
        PDFRenderer stringPDFRenderer = new StringPDFRenderer(document);
        PDFPrintable printable = new PDFPrintable(document, Scaling.ACTUAL_SIZE, showPageBorder,
                dpi, true, stringPDFRenderer);
